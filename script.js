const products = [
    ...
    {id: 10,name:"Redmi Note 13",Image:"https://m.media-amazon.com/images/I/71VW8LmqqPL.AC_UF1000,1000_QL80.jpg",Price:13500},
...
function renderSubtotal(cart){
    ...
    if(cart.length >0){
        ...
        subtotalContainer.innerHTML = `No item in cart`
    }
}
